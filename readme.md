# Spring PetClinic Sample Application [![Build Status](https://travis-ci.org/mpollock2/spring-petclinic.png?branch=master)](https://travis-ci.org/mpollock2/spring-petclinic/)
